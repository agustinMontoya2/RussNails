...
function Card({nail}: any) {
  ...
  return (
    <div className="bg-[#FFFFFF] h-[24rem] w-[24rem] hover:scale-110 flex-shrink-0 flex flex-col items-center justify-evenly rounded-xl transition-all duration-300 ease-in-out shadow-centered hover:shadow-hoverCentered">
